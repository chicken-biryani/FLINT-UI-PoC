...
export default {
  ...
  methods: {
    ...
    send_point_config_as_json: function () {
      // console.log(point_FLINT_config)
      var FLINT_config_string = JSON.stringify(point_FLINT_config)
      // console.log(FLINT_config_string)
      var preprocessed_FLINT_config_string = FLINT_config_string.replaceAll('"#$', ' ')
      // console.log(preprocessed_FLINT_config_string)
      var final_FLINT_config_string = preprocessed_FLINT_config_string.replaceAll('#$"', ' ')
      // console.log(final_FLINT_config_string)
      axios.post('http://127.0.0.1:8080/point', final_FLINT_config_string)
        .then(response => console.log(response))
        .catch(error => console.log(error))
    ...
    send_rothc_config_as_json: function () {
      // console.log(rothc_FLINT_config)
      var FLINT_config_string = JSON.stringify(rothc_FLINT_config)
      // console.log(FLINT_config_string)
      var preprocessed_FLINT_config_string = FLINT_config_string.replaceAll('"#$', ' ')
      // console.log(preprocessed_FLINT_config_string)
      var final_FLINT_config_string = preprocessed_FLINT_config_string.replaceAll('#$"', ' ')
      // console.log(final_FLINT_config_string)
      axios.post('http://127.0.0.1:8080/rothc', final_FLINT_config_string)
